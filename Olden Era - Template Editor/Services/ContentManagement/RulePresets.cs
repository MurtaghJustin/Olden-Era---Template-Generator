...
public static class RulePresets
{
    ...
    public static ContentPlacementRule TownDistance(DistanceVariation distance, int weight = 1) =>
        new ContentPlacementRule { Type = "MainObject", Args = ["0"], TargetMin = distance.Min, TargetMax = distance.Max, Weight = weight };
